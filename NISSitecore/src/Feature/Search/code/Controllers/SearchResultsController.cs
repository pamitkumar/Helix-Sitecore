...
using static NISSitecore.Feature.Search.Models.SearchResultsViewModel;

namespace NISSitecore.Feature.Search.Controllers
{
    public class SearchResultsController : SitecoreController
    {
        private readonly ISearchServiceRepository _searchService;

        /// <summary>
        /// Creates a new instance of the <see cref="SearchResultsController"/> class.
        /// </summary>
        public SearchResultsController(ISearchServiceRepository searchService)
        {
            // TODO: inject with DI
        ...
        public ActionResult SearchResults(string q, int pageNumber = 1, string facet = "")
        {
            ...
            // Convert Sitecore item into a IDBSolrQuery.
            IDBSolrQuery query = _searchService.BuildIDBSolrQueryFromItem(datasourceItem);
        ...
        {
            public const string SearchResults = "~/Views/Search/SearchResults.cshtml";
        }
