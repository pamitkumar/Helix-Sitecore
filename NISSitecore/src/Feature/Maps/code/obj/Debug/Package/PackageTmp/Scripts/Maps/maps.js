(function (window, $, google) {
    ...
    function loadMapJsScript() {
        var scriptTag = $('script[data-key="AIzaSyBRkVFDLRgXcuMXyVpMltxDHoKj05xz5vk"]');
        if (scriptTag.length == 0) {
            ...
            fileref.setAttribute("data-key", "AIzaSyBRkVFDLRgXcuMXyVpMltxDHoKj05xz5vk");
        ...
        function getMarker(map, mapPoint) {
            ...
            if (latlng) {
                ...
                var contentString =
                    ...
                    + "<strong>" + mapPoint.Name + "</strong><a href='#' style='float:right;'><img src='XXXX' /></a><br>" + mapPoint.Address
                    + "</div>"
