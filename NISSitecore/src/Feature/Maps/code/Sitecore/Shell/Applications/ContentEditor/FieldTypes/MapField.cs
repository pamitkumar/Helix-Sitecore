...
namespace NISSitecore.Feature.Maps.Sitecore.Shell.Applications.ContentEditor.FieldTypes
{
    public class MapField: ContentEditor_Text, IContentField
    {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            var mapImageCtrl = new System.Web.UI.WebControls.Image
            {
        ...
        {
            return string.Format("http://maps.googleapis.com/maps/api/staticmap?center={0}&zoom={1}&size={2}x{3}&sensor=false&maptype=roadmap&&markers=color:blue%7Clabel:Location%7C{0}&key=AIzaSyBRkVFDLRgXcuMXyVpMltxDHoKj05xz5vk", this.GetValue(), this.mapZoomFactor, this.mapWidth, this.mapHeight);
        }
